  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/clients',
        builder: (context, state) =>
            const AppShell(currentIndex: 4, child: ClientsScreen()),
      ),
      GoRoute(
        path: '/history',
        builder: (context, state) =>
            const AppShell(currentIndex: 5, child: InvoiceHistoryScreen()),
      ),
      GoRoute(
        path: '/settings',
        builder: (context, state) =>
            const AppShell(currentIndex: 6, child: SettingsScreen()),
      ),
    ],
  );
});
